...
class Test(omni.kit.test.AsyncTestCase):
    ...
    async def test_window_button(self):
        ...
        label = ui_test.find("Python ia teste powered by gemini//Frame/**/Label[*]")

        # Find buttons in our window
        add_button = ui_test.find(
            "Python ia teste powered by gemini//Frame/**/Button[*].text=='Add'"
        )
        reset_button = ui_test.find(
            "Python ia teste powered by gemini//Frame/**/Button[*].text=='Reset'"
        )
